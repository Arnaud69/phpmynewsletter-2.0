...
<html lang="<?php echo tr("LN");?>">
    ...
    <?php } ?>
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="navbar-header">
                ...
                <div class="logo">
                    <h1><a href="https://www.phpmynewsletter.com/" target="_blank" data-toggle="tooltip" data-placement="auto" title="Accés au portail PhpMyNewsLetter"></a></h1>
                </div>
            </div>
                ...
                ?>
                    <div class="row">
                        ...
                        <?php
                            ...
                            echo '<li><a href="?page=listes&token=' . $token . '&l=l">' . tr("ADMINISTRATION") . '</a></li>';
                            switch ( $page) {
                                case 'listes':
                                    echo '<li class="active">'.tr("LISTS").'</li>';
                                    echo ($l=='l' ? '<li class="active">'.tr("LIST_OF_LISTS").'</li>' : 
                                                    '<li class="active">'.tr("CREATION_NEW_LIST").'</li>');
                                break;
                                case 'globalstats':
                                    echo '<li class="active">'.tr("GLOBAL_STATISTICS").'</li>';
                                break;
                                case 'manage_senders':
                                    echo '<li class="active">'.tr("SENDERS_MANAGEMENT").'</li>';
                                break;
                                case 'wysiwyg':
                                    echo '<li class="active">'.tr("WYSIWYG_EDITOR").'</li>';
                                break;
                                case 'subscribers':
                                    echo '<li class="active">'.tr("MENU_SUBSCRIBERS").'</li>';
                                    echo '<li class="active">'.tr("SUBSCRIBER_MANAGEMENT").'</li>';
                                break;
                                case 'profils':
                                    echo '<li class="active">'.tr("MENU_SUBSCRIBERS").'</li>';
                                    echo '<li class="active">'.tr("SUBSCRIBER_PROFILS").'</li>';
                                break;
                                case 'newsletterconf':
                                    echo '<li class="active">'.tr("MENU_NEWSLETTER") . '</li>';
                                break;
                                case 'compose':
                                    echo '<li class="active">'.tr("MENU_COMPOSE").'</li>';
                                    echo ($op=='init'?'<li class="active">'.tr("INITIAL_WORDING").'</li>':
                                        ($op=='preview'?'<li class="active">'.tr("SCREEN_PREVIEW").'</li>':
                                            ($op=='send_preview'?'<li> <a class="current" id="smail"></a>'.tr("SENDING_TEST_MAIL").'</li>':
                                                ($op=='preview'?'<li class="active">'.tr("SCREEN_PREVIEW").'</li>':
                                                    '<li class="active">'.tr("INITIAL_WORDING").'</li>'
                                                )
                                            )
                                        )
                                    );
                                break;
                                case 'tracking':
                                    echo '<li class="active">'.tr("TRACKING") . '</li>';
                                    echo '<li class="active">'.tr("RESULTS").'</li>';
                                break;
                                case 'undisturbed':
                                    echo '<li class="active">'.tr("MANAGEMENT_UNDISTRIBUTED") . '</li>';
                                    echo '<li class="active">'.tr("ANALYSIS_OF_RETURNS").'</li>';
                                break;
                                case 'archives':
                                    echo '<li class="active">'.tr("MANAGEMENT_ARCHIVE") . '</li>';
                                    echo '<li class="active">'.tr("MENU_ARCHIVES").'</li>';
                                break;
                                case 'task':
                                    echo '<li class="active">'.tr("SCHEDULED_TASKS") . '</li>';
                                    echo '<li class="active">'.tr("MANAGEMENT_SCHEDULED_TASKS").'</li>';
                                break;
                                case 'manager_mailq':
                                    echo '<li class="active">'.tr("PENDING_MAILS") . '</li>';
                                    echo '<li class="active">'.tr("PENDING_MAILS_MANAGEMENT").'</li>';
                                break;
                                case 'configsmtp':
                                    echo '<li class="active">'.tr("MENU_CONFIG").'</li>';
                                    echo '<li class="active">'.tr("GCONFIG_SMTP_LB_TITLE").'</li>';
                                break;
                                case 'config':
                                    echo '<li class="active">'.tr("MENU_CONFIG").'</li>';
                                break;
                                case 'soft':
                                    echo '<li class="active">'.tr("MENU_CONFIG").'</li>';
                                    echo '<li class="active">'.tr("GCONFIG_SOFTWARE_TITLE").'</li>';
                                break;
                                case 'backup':
                                    echo '<li class="active">'.tr("MENU_CONFIG").'</li>';
                                    echo '<li class="active">Gestion des sauvegardes</li>';
                                break;
                                case 'manage_users':
                                    echo '<li class="active">'.tr("MENU_CONFIG").'</li>';
                                    echo '<li class="active">Gestion des droits et des utilisateurs</li>';
                                break;
                                case 'about':
                                    echo '<li class="active">A propos de PhpMyNewsLetter...</li>';
                                break;
                            }
                            echo '</ul>';
                        ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php if( $page!='globalstats' && $page!='config' && ($page=='listes' && $l!='c') ) { ?>
                                <div class="content-box-header">
                                    <div class="panel-title"><?php 
                                        echo tr("DASHBOARD");?> : <?php echo ($list_name==-1||trim($list_name)=='' ? tr("NEWSLETTER_CREATE") : $list_name);
                                    ?></div>
                                </div>
    ...
    $('.tooltip').tooltip();
    // Menu dropdown et up, délais : 50ms, fadein et out : 50 ms
