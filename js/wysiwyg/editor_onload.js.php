...
function upload_append() {
    $(document).on('click', '.img_upload', function() {
        ...
        $(this).parents(".imgpop").append('<div class="darkoverlay_imgupload">' +
            ...
            '<input id="uploadBtn" name="ImageFile" type="file" required  class="upload" value="" />' +
            '<input id="imgwidth"  name="imgwidth"  type="hidden" class="upload" value="" />' +
            '<input id="imgheight" name="imgheight" type="hidden" class="upload" value="" />' +
            '</div>' +
