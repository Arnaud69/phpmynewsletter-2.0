...
$(document).ready(function () {
    ...
    $(".editor_rightside .emailrender").sortable({
        ...
        helper:function(){
            return $("<div class='highlight' style='height:40px;text-align:center;line-height:40px;border:2px solid #357EBD'><div style='background-color:#fff;width:600px;margin:auto; color:#357EBD;'>Déplacement du block</div></div>");
        }
    });
