...
(function ($) {
    var colpick = function () {
        var
            tpl = '<div class="colpick"><h1>Choisissez votre couleur</h1>'
            + '<div class="colpick_color"><div class="colpick_color_overlay1"><div class="colpick_color_overlay2">'
            + '<div class="colpick_selector_outer"><div class="colpick_selector_inner"></div></div></div></div></div>'
            + '<div class="colpick_hue"><div class="colpick_hue_arrs"><div class="colpick_hue_larr"></div>'
            + '<div class="colpick_hue_rarr"></div></div></div><div class="colpick_new_color"></div>'
            + '<div class="colpick_current_color"></div><div class="colpick_hex_field">'
            + '<div class="colpick_field_letter">#</div><input type="text" maxlength="6" size="6" /></div>'
            + '<div class="colpick_rgb_r colpick_field"><div class="colpick_field_letter">R</div>'
            ...
            + '<div class="colpick_rgb_g colpick_field"><div class="colpick_field_letter">G</div>'
            + '<input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs">'
            + '<div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div>'
            + '<div class="colpick_rgb_b colpick_field"><div class="colpick_field_letter">B</div>'
            + '<input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs">'
            + '<div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div>'
