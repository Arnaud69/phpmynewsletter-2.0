...
if (!empty($_FILES)) {
	...
	$new_target_name = preg_replace('/  +/','_',$_FILES['file']['name']);
	//$targetFile =  $targetPath. $_FILES['file']['name'];
	$targetFile =  $targetPath. $new_target_name;  
	//$targetFileThumb =  $targetPathThumb. $_FILES['file']['name'];
	$targetFileThumb =  $targetPathThumb. $new_target_name;
	...
	if($is_img){
		...
		if(!new_thumbnails_creation($targetPath,$targetFile, $new_target_name,$current_path,$relative_image_creation,$relative_path_from_current_pos,$relative_image_creation_name_to_prepend,$relative_image_creation_name_to_append,$relative_image_creation_width,$relative_image_creation_height,$fixed_image_creation,$fixed_path_from_filemanager,$fixed_image_creation_name_to_prepend,$fixed_image_creation_to_append,$fixed_image_creation_width,$fixed_image_creation_height)){
		    $memory_error=false;
		}else{		    
