...
if (!empty($_FILES)) {
	...
	if($is_img){
		...
		if(!new_thumbnails_creation($targetPath,$targetFile, $new_target_name,$current_path,$relative_image_creation,
                                    ...
                                    $fixed_image_creation_name_to_prepend,$fixed_image_creation_to_append,
