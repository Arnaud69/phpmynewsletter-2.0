...
switch ($op)
{
    case 'init':
        ...
        if (getSubscribersNumbers($cnx, $row_config_globale['table_email'], $list_id))
        {
            ...
            echo '<div class="row">
			<div class="col-md-6">
            			<h4>' . tr("COMPOSE_NEW") . '</h4>
				'.tr("COMPOSE_SUBJECT") . ' : ' . tr("RFC_2822") . '<br><br>
				<div class="row">
					<div class="col-md-11">
            ...
            echo "<hr>";
            echo "<input type='checkbox' name='encode' value='base64'>&nbsp;" . tr("COMPOSE_ENCODE") . " ?<hr>";
            ...
            echo "<script>
                    ...
                    tinymce.init({
                        ...
                        templates : [ ";
            $tPath = $PATH . "js/tinymce/templates/";
            echo "
    ...
    case "preview":
        ...
        echo "<div class='iframePreview'><iframe src='preview.php?list_id=$list_id&token=$token' width='100%' height='300px' frameborder='0' style='border:0;' scrolling='no' id='_preview' scrolling='no' onload='rszifr(this)'><p>" . tr("ERROR_IFRAME") . "...</p></iframe></div>";
