...
if(count($row)>0){
        ...
        ?>
            ...
            <table>
                ...
                <tr>
                    <td width="25%"><div align="center"><h4><?php echo tr("CLICKED_DISTINCT_DOMAINS"); ?></h4></div><canvas id="PmnlDistctDomain" />
                    </td>
                    <td width="25%"><div align="center"><h4><?php echo tr("CLICKED_BY_DOMAINS"); ?></h4></div><canvas id="PmnlCntClkDomain" />
                    </td>
                    <td width="50%" colspan=2 rowspan=2 align="center"><h4><?php echo tr('CLICK_BY_HOURS'); ?></h4><canvas id="ClicByHours" style="width:70%;height:300px;"></canvas>
                    </td>
                </tr>
                <tr>
                    <td><div id="PmnlDistctDomain-legend" class="chart-legend"></div>
                    </td>
                    <td><div id="PmnlCntClkDomain-legend" class="chart-legend"></div>
                    </td>
                    <td>
                    </td>
                </tr>
