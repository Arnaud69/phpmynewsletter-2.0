...
<table width="100%" bgcolor="#fcfcfc" cellpadding="0" cellspacing="0" border="0" st-sortable="one-big-image">
<tbody>
    <tr>
        <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                            ...
                            <table width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                                <tbody>
                                    <tr>
                                        <!-- start of image -->
                                        <td align="center">
                                            <a target="_blank" href="#"><img width="600" border="0" alt="" style="display:block; border:none; outline:none; text-decoration:none;" src="https://placeholdit.imgix.net/~text?w=600&h=300" class="one-big-image" st-image="one-big-image"></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td width="43" height="43" align="center">
                                                            <a target="_blank" href="#">
                                                                <img st-image="facebook" src="<?php echo $row_config_globale['base_url'] . $row_config_globale['path'] ; ?>css/facebook.png" alt="" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;" /></a>
                                                        </td>
                                                        <td align="left" width="20" style="font-size:1px; line-height:1px;"> </td>
                                                        <td width="43" height="43" align="center">
                                                            <a target="_blank" href="#">
                                                                <img st-image="twitter" src="<?php echo $row_config_globale['base_url'] . $row_config_globale['path'] ; ?>css/twitter.png" alt="" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;" /></a>
                                                        </td>
                                                        <td align="left" width="20" style="font-size:1px; line-height:1px;"> </td>
                                                        <td width="43" height="43" align="center">
                                                            <a target="_blank" href="#">
                                                                <img st-image="linkedin" src="<?php echo $row_config_globale['base_url'] . $row_config_globale['path'] ; ?>css/linkedin.png" alt="" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;" /></a>
                                                        </td>
                                                        <td align="left" width="20" style="font-size:1px; line-height:1px;"> </td>
                                                        <td width="43" height="43" align="center">
                                                            <a target="_blank" href="#">
                                                                <img st-image="youtube" src="<?php echo $row_config_globale['base_url'] . $row_config_globale['path'] ; ?>css/youtube.png" alt="" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;" /></a>
                                                        </td>
                                                        <td align="left" width="20" style="font-size:1px; line-height:1px;"> </td>
                                                        <td width="43" height="43" align="center">
                                                            <a target="_blank" href="#">
                                                                <img st-image="google+" src="<?php echo $row_config_globale['base_url'] . $row_config_globale['path'] ; ?>css/googleplus.png" alt="" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;" /></a>
                                                        </td>
                                                        <td align="left" width="20" style="font-size:1px; line-height:1px;"> </td>
                                                        <td width="43" height="43" align="center">
                                                            <a target="_blank" href="#">
                                                                <img st-image="pinterest" src="<?php echo $row_config_globale['base_url'] . $row_config_globale['path'] ; ?>css/pinterest.png" alt="" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;" /></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
