...
if(!imap_open("{".$bounce_host.":".$bounce_port.$bounce_service.$bounce_option."}".$mail_folder,$bounce_user,$bounce_pass,$option,1)){
    echo '<span style="color:red;font-weight:bold">Pas de connexion : {'.$bounce_host.':'.$bounce_port.$bounce_service.$bounce_option.'}'.$mail_folder.','.$bounce_user.',********* : '.imap_last_error().'</span>';
}else{
    echo '<span style="color:green;font-weight:bold">Connexion réussie : {'.$bounce_host.':'.$bounce_port.$bounce_service.$bounce_option.'}'.$mail_folder.','.$bounce_user.',*********</span>';
}
