                    ...
                    <div class="sidebar content-box fixed" style="display: block;">
                        <ul class="nav">
                            ...
                            if($_SESSION['dr_abonnes']=='Y'||$_SESSION['dr_is_admin']==true) { ?>
	                            <li <?php echo ($page=='subscribers'?'class="current"':"");?>><a href="?page=subscribers&token=<?php echo $token;?>&list_id=<?php echo $list_id;?>"><i class="glyphicon glyphicon-user"></i> <?php echo tr("SUBSCRIBER_MANAGEMENT");?></a></li>
	                            <li <?php echo ($page=='profils'?'class="current"':"");?>><a href="?page=profils&token=<?php echo $token;?>&list_id=<?php echo $list_id;?>"><i class="glyphicon glyphicon-stats"></i> <?php echo tr("SUBSCRIBER_PROFILS");?></a></li>
                            <?php }
                            if($_SESSION['dr_is_admin']==true) { ?>
                            ...
                            <?php }
                            if($_SESSION['dr_stats']=='Y'||$_SESSION['dr_is_admin']==true) { ?>
                            	<li <?php echo ($page=='tracking'?'class="current"':"");?>><a href="?page=tracking&token=<?php echo $token;?>&list_id=<?php echo $list_id;?>&data=ch"><i class="glyphicon glyphicon-stats"></i> <?php echo tr("STATS_NUMBER_AND GRAPHICS");?></a></li>
                            <?php }
