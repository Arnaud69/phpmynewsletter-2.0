...
if(!$i && !$l && !$e && !$h) {
    ...
    $body .= translate("READ_ON_LINE", "<a href='" . $row_config_globale['base_url'] . $row_config_globale['path'] . "online.php?i=$i&list_id=$l&email_addr=$e&h=$h'>")."<br />";
    ...
    $unsubLink = "<br /><div align='center' style='padding-top:10px;font-size:10pt;font-family:arial,helvetica,sans-serif;padding-bottom:10px;color:#878e83;'><hr noshade='' color='#D4D4D4' width='90%' size='1'>"
               .translate("UNSUBSCRIBE_LINK","<a href='" . $row_config_globale['base_url'] . $row_config_globale['path'] . "subscription.php?i=$i&list_id=$l&op=leave&email_addr=$e&h=$h' style='' target='_blank'>")
