				...
				if ( empty( $c ) || ( $_POST[ 'c' ] != $_SESSION[ 'c' ] ) ) {
					...
					if ( $row_config_globale[ 'mod_sub' ] == "0" ) {
						...
						if ( strlen( $add ) > 3 ) {
							...
							$body .= "<a href='" . $row_config_globale[ 'base_url' ] . $row_config_globale[ 'path' ] 
								. "subscription.php?op=confirm_join&email_addr=" . urlencode( $email_addr ) 
					...
					if ( $add ) {
						...
						if ( $row_config_globale[ 'alert_sub' ] == 1 ) {
							...
							$rapport       = '<br /><br /><br /><br /><br />
								...
								<tbody>
								<tr><td style="text-align: center;" colspan="2"><span style="color: #2446a2;font-size: 14pt;">
									<img src="https://www.phpmynewsletter.com/css/images/phpmynewsletter_v2.png" alt="" width="123" height="72" /><br />' 
