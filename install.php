			...
			<div class="panel panel-primary">
				...
				<?php
					...
					if (empty($langfile)) {
						...
						echo "<option value='dev' selected>".tr("INSTALL_DEVELOPMENT")."</option><option value='prod'>".tr("INSTALL_PRODUCTION")."</option>";
						...
						echo "<div class='row'><div class='col-md-4'>".tr("INSTALL_ADMIN_BASEURL"). 	" : </div><div class='col-md-6'><input class='form-control' type='text'  name='base_url' size='30' value='".(isset($_SERVER['HTTPS']) ? "https" : "http")."://" . $_SERVER['HTTP_HOST'] . "/'><span style='text-transform: lowercase;'>(" . tr("EXAMPLE") . " : http://www.mydomain.com/)</span></div></div><br>";
						echo "<div class='row'><div class='col-md-4'>".tr("INSTALL_ADMIN_PATH_TO_PMNL")." : </div><div class='col-md-6'><input class='form-control' type='text'  name='path' size='30' value='".str_replace($_SERVER['DOCUMENT_ROOT'].'/', "",(__DIR__))."/'><span style='text-transform: lowercase;'>(" . tr("EXAMPLE") . " : tools/newsletter/)</span></div></div><br>";
						...
						if ($db_type == "mysql") {
							if ($createtables == 1) {
								...
								$sql = 'CREATE TABLE IF NOT EXISTS `' . $table_prefix . 'email` (
									...
									`type` ENUM("","autoreply","locked","generic","soft","hard","temporary") NOT NULL DEFAULT "",
